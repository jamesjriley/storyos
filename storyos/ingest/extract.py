...
def extract_to_proposals(*, project_dir: str, input_path: str, max_lines_per_chunk: int=80, overlap: int=10) -> IngestResult:
    ...
    out = llm.generate(messages, model=cfg.llm.model, temperature=0.2).text
